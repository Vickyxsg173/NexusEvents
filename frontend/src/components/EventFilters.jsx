  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 mb-8 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Organizer Filter */}
        <div>
          <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1 uppercase tracking-wider">Organizer</label>
          <select 
          ...
          >
            ...
            <option value="Major League Hacking (MLH)">Major League Hacking (MLH)</option>
            ...
            <option value="GitHub Internships (Simplify)">GitHub Internships (Simplify)</option>
            <option value="Google Developer Groups (GDG)">Google Developer Groups (GDG)</option>
            <option value="GitLab">GitLab</option>
            <option value="GitHub Internships">GitHub Internships</option>
            <option value="AWS Events">AWS Events</option>
            <option value="GenAI Fund">GenAI Fund</option>
            <option value="CNCF">CNCF</option>
            <option value="Meetup">Meetup</option>
          </select>
        </div>

        {/* Extra Filters (Development Only) */}
        {import.meta.env.DEV && (
          <>
            {/* Mode Filter */}
            <div>
