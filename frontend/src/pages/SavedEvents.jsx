    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <h3 className="text-xl font-medium text-slate-900 dark:text-white">No saved events yet</h3>
          <p className="mt-2 text-slate-500 dark:text-slate-400 mb-6">Explore the dashboard and click the bookmark icon to save events here.</p>
          <Link 
            to="/" 
